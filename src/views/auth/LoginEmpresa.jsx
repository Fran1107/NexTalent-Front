    ...
    return (
        <div className="flex w-full max-w-5xl bg-white rounded-3xl shadow-2xl overflow-hidden min-h-[600px]">
            ...
            <div className="w-full md:w-1/2 p-8 md:p-12 flex flex-col justify-center">
                <h2 className="text-3xl font-bold text-center mb-8">Ingresa a tu cuenta de empresa</h2>
                ...
                <div className="mt-8 text-center">
                    <p className="text-gray-600">¿No tenés cuenta? <a href="/registro/empresa" className="text-[#4D1874] font-bold hover:underline">Registra tu empresa</a></p>
                </div>
            </div>

            {/* LADO DERECHO - Note que cambio el titulo */}
            <RightLoginCard
                image={empresaImage}
                titleLine1="¡Ofrece las mejores pasantías"
                titleLine2="para el mejor talento!"
            />
        </div>
    );
}