    ...
    return (
        ...
        <div className=" items-start">
          ...
          <div className="bg-white rounded-3xl shadow-lg p-8 border border-gray-200">
            ...
            {/* /* Botón de Google */}
            <button className="w-full bg-gradient-to-r from-blue-400 via-purple-300 to-pink-300 text-gray-800 font-semibold py-3 px-6 rounded-full flex items-center justify-center gap-3 mb-6 hover:opacity-90 transition ">
