    ...
    return (
        ...
        >
            ...
            <div className="container mx-auto px-6 text-center relative z-10">
                ...
                <p className="text-4xl mb-8 opacity-70">
                    Encontrá tu lugar
                </p>
                ...
                <div className="relative max-w-xl mx-auto mt-6">
                    <input
                        ...
                        className="w-full px-4 py-3 pr-10 bg-gray-200 rounded-full text-sm outline-none focus:ring-2 focus:ring-purple-400 placeholder-gray-600 text-gray-900"
                    />
